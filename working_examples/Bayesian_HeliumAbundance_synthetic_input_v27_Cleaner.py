...
from lib.Astro_Libraries.Abundances_InferenceModel_Helium_v39 import Run_MCMC
   
iterat, burn, thin  = 10000, 0, 1
sim_model           = 'CleanerShorter'
...
# dz.data_plot(bm.obj_data['obs_wave_resam'], bm.obj_data['obs_flux_norm_masked'], label = 'obs_flux_norm')
