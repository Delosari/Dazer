...
# axis.plot(synth_SED['obs_wave'], synth_SED['obs_flux_err'], label='Err spectrum')
axis.plot(fit_data['obs_wave_resam'], output_data['flux_sspFit'] , label='Output fit', linestyle=':')
