...
from numpy import concatenate, ones, power, searchsorted, sqrt, std, where, loadtxt, linspace, median, max as npmax, True_, False_, bool_
from uncertainties import ufloat 
from DZ_Logs import LineMesurer_Log
from pandas.core.frame import DataFrame
from lib.Math_Libraries.FittingTools import Fitting_Gaussians, Python_linfit, gaussian_components, gaussian_curve, gaussian_mixture
...
class LineMesurer(Fitting_Gaussians, LineMesurer_Log):
    ...
    def check_GaussianMixture(self, SubWave, Methodology, lines_dataframe, force_check = True):
        ...
        if 'MC' not in self.fit_dict['fit_routine']:
            self.fit_dict['MC_iterations'] = 100
        else:
