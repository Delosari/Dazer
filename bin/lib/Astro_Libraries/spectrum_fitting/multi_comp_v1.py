...
from numpy import array, savetxt, loadtxt, genfromtxt, copy, isnan, arange, insert, concatenate, mean, std, power, exp, zeros, \
...
class Import_model_data(ssp_synthesis_importer):
    ...
    def import_emission_line_data(self, obj_lines_df, input_ions):
        ...
        idx_recomb = (obj_lines_df.emis_type == 'rec') & (obj_lines_df.ion.isin(input_ions)) & (obj_lines_df.index != 'H1_4861A')
    ...
    def import_emissivity_grids(self):
        ...
        print 'bichos', self.obj_data['recombLine_pynebCode']
...
class SpecSynthesizer(SpectrumFitter):
    ...
    def fit_observation(self, model_name, obs_data, ssp_data, iterations=15000, burn=7000, thin=1, output_folder = None,
        ...
        # Select model
        self.select_inference_model(model_type, params_list)
    ...
    def detect_model(self):
        ...
        cHbeta      = pymc2.TruncatedNormal('cHbeta', 0.15, 0.05 ** -2, a=0.0, b=3.0)  if 'cHbeta' in self.params_list else 0.0
