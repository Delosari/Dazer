...
from numpy          import sum as np_sum,square,  mean, array, power, log10, linspace, exp, zeros, ceil, interp, isnan, searchsorted, median, argmin, concatenate, invert, argwhere, diff, r_, std
...
class NebularContinuumCalculator():
    ...
    def PropertiesFromlog_TOCOMPLETE(self):
    
        print 'Llename de cosas!!!'
