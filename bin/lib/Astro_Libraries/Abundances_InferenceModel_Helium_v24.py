...
class Inference_AbundanceModel(Import_model_data, Collisional_FluxCalibration, Recombination_FluxCalibration, Continua_FluxCalculation, Nebular_FluxCalculation):
    ...
    def He_O_S_nebStellar_model(self):
        ...
        S2_abund    =   pymc2.Uniform(          'S2_abund',     0.000001,                   0.15, value=1e-5)
        S3_abund    =   pymc2.Uniform(          'S3_abund',     0.000001,                   0.15, value=1e-5)
        O2_abund    =   pymc2.Uniform(          'O2_abund',     0.000001,                   0.15, value=0.0001)
        O3_abund    =   pymc2.Uniform(          'O3_abund',     0.000001,                   0.15, value=0.0001)                        
