...
def Figure_Legends_Colors(ColorVector):
    ...
    List_Ionization_factor = ['-3.0', '-2.5', '-2.0', '-1.5', '-1.0', '-0.5']
#     List_Ionization_factor = ['-3.0', '-2.0', '-1.0']
    ColorVector[2] = ['yellow', 'orange', 'blue', 'purple', 'brown', 'green']
  
    for i in range(len(List_Ionization_factor)):
  
        ionization = List_Ionization_factor[i]
  
        Model_dict['_' + ionization  + '_z0.004_age5.0'] = [ionization,'log age = 5.0 log z = -2.4, file="sp-kro_z0001-z05_stellar.mod"']
        Model_dict['_' + ionization  + '_z0.004_age5.5'] = [ionization,'log age = 5.5 log z = -2.4, file="sp-kro_z0001-z05_stellar.mod"']
        Model_dict['_' + ionization  + '_z0.004_age6.0'] = [ionization,'log age = 6.0 log z = -2.4, file="sp-kro_z0001-z05_stellar.mod"']
        Model_dict['_' + ionization  + '_z0.004_age6.5'] = [ionization,'log age = 6.5 log z = -2.4, file="sp-kro_z0001-z05_stellar.mod"']
#         Model_dict['_' + ionization  + '_z0.004_age7.0'] = [ionization,'log age = 7.0 log z = -2.4, file="sp-kro_z0001-z05_stellar.mod"']
#         Model_dict['_' + ionization  + '_z0.004_age7.5'] = [ionization,'log age = 7.5 log z = -2.4, file="sp-kro_z0001-z05_stellar.mod"']
           
        Model_dict['_' + ionization  + '_z0.008_age5.0'] = [ionization,'log age = 5.0 log z = -2.1, file="sp-kro_z0001-z05_stellar.mod"']
        Model_dict['_' + ionization  + '_z0.008_age5.5'] = [ionization,'log age = 5.5 log z = -2.1, file="sp-kro_z0001-z05_stellar.mod"']
        Model_dict['_' + ionization  + '_z0.008_age6.0'] = [ionization,'log age = 6.0 log z = -2.1, file="sp-kro_z0001-z05_stellar.mod"']
        Model_dict['_' + ionization  + '_z0.008_age6.5'] = [ionization,'log age = 6.5 log z = -2.1, file="sp-kro_z0001-z05_stellar.mod"']
#         Model_dict['_' + ionization  + '_z0.008_age7.0'] = [ionization,'log age = 7.0 log z = -2.1, file="sp-kro_z0001-z05_stellar.mod"']
#         Model_dict['_' + ionization  + '_z0.008_age7.5'] = [ionization,'log age = 7.0 log z = -2.1, file="sp-kro_z0001-z05_stellar.mod"']
                   
        Model_dict['_' + ionization  + '_z0.02_age5.0'] = [ionization,'log age = 5.0 log z = -1.7, file="sp-kro_z0001-z05_stellar.mod"']
        Model_dict['_' + ionization  + '_z0.02_age5.5'] = [ionization,'log age = 5.5 log z = -1.7, file="sp-kro_z0001-z05_stellar.mod"']
        Model_dict['_' + ionization  + '_z0.02_age6.0'] = [ionization,'log age = 6.0 log z = -1.7, file="sp-kro_z0001-z05_stellar.mod"']
        Model_dict['_' + ionization  + '_z0.02_age6.5'] = [ionization,'log age = 6.5 log z = -1.7, file="sp-kro_z0001-z05_stellar.mod"']
#         Model_dict['_' + ionization  + '_z0.02_age7.0'] = [ionization,'log age = 7.5 log z = -2.1, file="sp-kro_z0001-z05_stellar.mod"']
#         Model_dict['_' + ionization  + '_z0.02_age7.5'] = [ionization,'log age = 7.5 log z = -2.1, file="sp-kro_z0001-z05_stellar.mod"']
          
        Model_dict['_' + ionization  + '_z0.05_age5.0'] = [ionization,'log age = 5.0 log z = -1.31, file="sp-kro_z0001-z05_stellar.mod"']
        Model_dict['_' + ionization  + '_z0.05_age5.5'] = [ionization,'log age = 5.5 log z = -1.31, file="sp-kro_z0001-z05_stellar.mod"']
        Model_dict['_' + ionization  + '_z0.05_age6.0'] = [ionization,'log age = 6.0 log z = -1.31, file="sp-kro_z0001-z05_stellar.mod"']
        Model_dict['_' + ionization  + '_z0.05_age6.5'] = [ionization,'log age = 6.5 log z = -1.31, file="sp-kro_z0001-z05_stellar.mod"']
#         Model_dict['_' + ionization  + '_z0.05_age7.0'] = [ionization,'log age = 7.0 log z = -1.31, file="sp-kro_z0001-z05_stellar.mod"']
#         Model_dict['_' + ionization  + '_z0.05_age7.5'] = [ionization,'log age = 7.5 log z = -1.31, file="sp-kro_z0001-z05_stellar.mod"']
       
        Legends_dict['_' + ionization  + '_z0.004_age5.0'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.004_age5.5'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.004_age6.0'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.004_age6.5'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.004_age7.0'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.004_age7.5'] = 'Ionization factor: ' + ionization
             
        Legends_dict['_' + ionization  + '_z0.008_age5.0'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.008_age5.5'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.008_age6.0'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.008_age6.5'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.008_age7.0'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.008_age7.5'] = 'Ionization factor: ' + ionization
             
        Legends_dict['_' + ionization  + '_z0.02_age5.0'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.02_age5.5'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.02_age6.0'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.02_age6.5'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.02_age7.0'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.02_age7.5'] = 'Ionization factor: ' + ionization
            
        Legends_dict['_' + ionization  + '_z0.05_age5.0'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.05_age5.5'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.05_age6.0'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.05_age6.5'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.05_age7.0'] = 'Ionization factor: ' + ionization
        Legends_dict['_' + ionization  + '_z0.05_age7.5'] = 'Ionization factor: ' + ionization
            
        Colors_dict['_' + ionization  + '_z0.004_age5.0'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.004_age5.5'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.004_age6.0'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.004_age6.5'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.004_age7.0'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.004_age7.5'] = ColorVector[2][i]
             
        Colors_dict['_' + ionization  + '_z0.008_age5.0'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.008_age5.5'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.008_age6.0'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.008_age6.5'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.008_age7.0'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.008_age7.5'] = ColorVector[2][i]
             
        Colors_dict['_' + ionization  + '_z0.02_age5.0'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.02_age5.5'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.02_age6.0'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.02_age6.5'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.02_age7.0'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.02_age7.5'] = ColorVector[2][i]
            
        Colors_dict['_' + ionization  + '_z0.05_age5.0'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.05_age5.5'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.05_age6.0'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.05_age6.5'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.05_age7.0'] = ColorVector[2][i]
        Colors_dict['_' + ionization  + '_z0.05_age7.5'] = ColorVector[2][i]
